...
const MISC = {
  ...
  "GROUND ALTITUDE ": { desc: `Altitude of surface.`, units: `Meters` },
  "HAND ANIM STATE ": {
  ...
  "VISUAL MODEL RADIUS ": { desc: `Model radius.`, units: `Meters` },
  "VELOCITY WORLD X ": {
...
const AMBIENT_WEATHER = {
  ...
  "AMBIENT WIND VELOCITY ": { desc: `Wind velocity.`, units: `Knots` },
  "AMBIENT WIND X ": {
  ...
  "BAROMETER PRESSURE ": { desc: `Barometric pressure.`, units: `Millibars` },
  "SEA LEVEL PRESSURE ": {
